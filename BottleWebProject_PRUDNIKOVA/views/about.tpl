% rebase('layout.tpl', title='Short content', year=year)
    ...
    <div class="col-md-5">
        <img width = "440" src="static\images\274px-Eugene_Onegin_book_edition.jpg"> 
    </div> 

    <h2><strong><font size = "14" face = "colonna mt"> Short Content - Evgeny Onegin</font></strong></h2>
    ...
    She says she still has feelings for him, but must remain faithful to her husband. Onegin is shocked by Tatiana's response.</p></font></p>

<div class="row">
    <div class="col-md-10">
        <h2><strong><font size = "14" face = "colonna mt">Chapter One</font></strong></h2>
    ...
    <div class="col-md-10">
        <h2><strong><font size = "14" face = "colonna mt">Chapter Two</font></strong></h2>
    ...
    <div class="col-md-10">
        ...
        At this point, Pushkin leaves the reader and takes a break until the next chapter.</p></font></p>
    </div>

    <div class="col-md-10">
        <h2><strong><font size = "14" face = "colonna mt">Chapter Four</font></strong></h2>
        ...
        The chapter ends with a premonitory reflection on Lensky's youthful ignorance about the boredom of marriage and about the transience or absence of Olga's love for him.</p></font></p>
    </div>

    <div class="col-md-10">
        <h2><strong><font size = "14" face = "colonna mt">Chapter Five</font></strong></h2>
        ...
        Onegin takes Olga away from Lensky and, using his charm, makes her fall in love with him. Seeing this, Lensky rushes out of the party in a rage with the idea of a duel.</p></font></p>
    </div>

    <div class="col-md-10">
        <h2><strong><font size = "14" face = "colonna mt">Chapter Six</font></strong></h2>
        ...
        At the end of the chapter, Pushkin talks about the loss of his poetic youth when he turns thirty and hopes that some of his former ardor will remain with him and will keep him cheerful.</p></font></p>
    </div>

    <div class="col-md-10">
        <h2><strong><font size = "14" face = "colonna mt">Chapter Seven</font></strong></h2>
    ...
    <div class="col-md-10">
        <h2><strong><font size = "14" face = "colonna mt">Chapter Eight</font></strong></h2>
        ...
        The novel comes to an end when Tatiana leaves Onegin in complete confusion, and her husband, the general, enters the room.</p></font></p>
    </div>
</div>
