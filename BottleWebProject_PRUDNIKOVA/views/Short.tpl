% rebase('layout.tpl', title='Short content', year=year) 
    ...
    <div class="col-md-5">
        <img width = "440" src="static\images\img_ShortContent\274px-Eugene_Onegin_book_edition.jpg"> <!--Добавление картинки!-->
    </div> 

    <h2><strong><ddkHading> Short Content - Evgeny Onegin</ddkHading></strong></h2><!--Изменение размера и типа шрифта в заголовке!-->
    <ddk><p>Evgeny Onegin, the main character of the novel, is a rich Russian aristocrat living in St. Petersburg. His life is full of balls, parties and social receptions. 
    ...
    She says she still has feelings for him, but must remain faithful to her husband. Onegin is shocked by Tatiana's response.</p></ddk><!--Текст, и задача размера и типа шрифта!-->

<div class="row">
    <div class="col-md-10">
        <h2><strong><ddkHading>Chapter One</ddkHading></strong></h2><!--Изменение размера и типа шрифта в заголовке!-->
        <p><ddk>The novel opens with a complaint by Eugene Onegin, the most titled character, about the boredom of caring for a dying uncle. Further, Pushkin presents the hero of the story as a young aristocrat, skilled in scholarship and, more importantly, dexterous in charm. An eloquent conversationalist who knows how to analyze and interpret others, Onegin easily succeeds in courting ladies in the high society of St. Petersburg.
    ...
    <div class="col-md-10">
        ...
        When Larin's father dies, Lensky goes to his grave and composes poems in memory of him. At the same time, Lensky painfully recalls the death of his own parents, and then Pushkin himself recalls the transience of life and the change of generations. At the end of the chapter, he expresses the hope that his work will preserve his name after his own departure from the world.</p></ddk><!--Текст, и задача размера и типа шрифта!-->
        </div>

    <div class="col-md-10">
        <h2><strong><ddkHading>Chapter Three</ddkHading></strong></h2><!--Изменение размера и типа шрифта в заголовке!-->
        <p><ddk>The chapter quotes the French poet Jacques Clincham de Malfilatra – "She was a girl, she was in love" - to state the theme: Tatiana's love for Onegin.
        ...
        At this point, Pushkin leaves the reader and takes a break until the next chapter.</p></ddk><!--Текст, и задача размера и типа шрифта!-->
    </div>

    <div class="col-md-10">
        <h2><strong><ddkHading>Chapter Four</ddkHading></strong></h2><!--Изменение размера и типа шрифта в заголовке!-->
        <p><ddk>Pushkin begins the chapter by condemning the cold, manipulative game of love, in which Onegin was once so skilled, but now deeply despises it. With this thought, Onegin abruptly and didactically refuses Tatiana, referring to her naivety and the unpleasantness of marriage, which he considers limiting and boring. Nevertheless, he admits that Tatiana has awakened a long-dormant feeling in him, but at the same time says that he is unworthy of her kindness. 
        ...
        The chapter ends with a premonitory reflection on Lensky's youthful ignorance about the boredom of marriage and about the transience or absence of Olga's love for him.</p></ddk><!-->Текст, и задача размера и типа шрифта<!-->
    </div>

    <div class="col-md-10">
        <h2><strong><ddkHading>Chapter Five</ddkHading></strong></h2><!--Изменение размера и типа шрифта в заголовке!-->
        <p><ddk>The chapter begins with the fact that winter is falling on the village. Following the tradition of celebrating New Year and Christmas, Larina's girls and their maids are guessing to get predictions about future husbands. Tatiana, in particular, takes fortune-telling very seriously, even to the point that she starts fortune-telling for the whole night. However, she gets scared of this idea and goes to bed.
        ...
        Onegin takes Olga away from Lensky and, using his charm, makes her fall in love with him. Seeing this, Lensky rushes out of the party in a rage with the idea of a duel.</p></ddk><!--Текст, и задача размера и типа шрифта!-->
    </div>

    <div class="col-md-10">
        <h2><strong><ddkHading>Chapter Six</ddkHading></strong></h2><!--Изменение размера и типа шрифта в заголовке!-->
        <p><ddk>The party at the Larins' house is coming to an end and Onegin, once again fed up with the festive life, returns home alone. While the household and guests are fast asleep, Tatiana worries about the events of the night.
        ...
        At the end of the chapter, Pushkin talks about the loss of his poetic youth when he turns thirty and hopes that some of his former ardor will remain with him and will keep him cheerful.</p></ddk><!--Текст, и задача размера и типа шрифта!-->
    </div>

    <div class="col-md-10">
        <h2><strong><ddkHading>Chapter Seven</ddkHading></strong></h2><!--Изменение размера и типа шрифта в заголовке!-->
        <p><ddk>With the melting of snow, spring blooms in the village. Nevertheless, Pushkin only reminds us of what has been lost and what cannot be reborn, as in nature. He draws attention to Onegin's house, abandoned by the owner, and goes to Lensky's grave, where Olga and Tatiana lay a funeral wreath.
        ...
        The Larins live with their aunt and take Tatiana to one social event after another. Longing for the familiar life in nature and books, Tatiana feels uncomfortable surrounded by gossips at a family gathering or in front of the dizzying energy of the ball. When the general shows interest in her, and she stands aside from dancing, the chapter comes to an end.</p></ddk><!--Текст, и задача размера и типа шрифта!-->
    </div>

    <div class="col-md-10">
        <h2><strong><ddkHading>Chapter Eight</ddkHading></strong></h2><!--Изменение размера и типа шрифта в заголовке!-->
        <p><ddk>Pushkin begins with memories of how he was a poetic prodigy at the Lyceum, and about the Muse who inspired him there. He follows her to the ball, where they are surprised to see Onegin, who has returned from the wanderings he made to distract himself from his guilt. Onegin himself, who is already 26 years old and has no purpose in life, is amazed by the appearance of Tatiana, now an exalted and mature woman, but still free from the artistry of high society. 
        ...
        The novel comes to an end when Tatiana leaves Onegin in complete confusion, and her husband, the general, enters the room.</p></ddk><!--Текст, и задача размера и типа шрифта!-->
    </div>
</div>